...
img1 = imread("LSU2/img1.jpg");
img2 = imread("LSU2/img2.jpg");
img3 = imread("LSU2/img3.jpg");
img4 = imread("LSU2/img4.jpg");
img5 = imread("LSU2/img5.jpg");
img6 = imread("LSU2/img6.jpg");
img7 = imread("LSU2/img7.jpg");
numImages =7;

images = cat(4, img1, img2, img3, img4, img5, img6, img7);
...
%     points = detectSURFFeatures(grayImage);   
    ...
    tforms(n) = estgeotform2d(matchedPoints, matchedPointsPrev,...
        'projective', 'Confidence', 50, 'MaxNumTrials', 2000);
